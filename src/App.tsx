  ...
  useEffect(() => {
    const handleSettle = () => {
      ...
      setTimeout(() => {
        ...
        const videos = [
          "/assets/Website Gif Kids Cartoon.mp4",
          "/assets/Website Gif Movie Spoof.mp4",
          "/assets/Website Gif Not Your Type Cartoon.mp4",
          "/assets/Website Gif Horror Stories.mp4",
          "/assets/Website Gif Story Animation.mp4"
        ];
        videos.forEach(src => {
